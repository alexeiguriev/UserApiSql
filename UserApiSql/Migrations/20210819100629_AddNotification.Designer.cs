...
namespace UserApiSql.Migrations
{
    ...
    [Migration("20210819100629_AddNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserApiSql.Models.Noti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UserApiSql.Models.Noti", b =>
                {
                    b.HasOne("UserApiSql.Models.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId");

                    b.HasOne("UserApiSql.Models.User", "ToUser")
                        .WithMany()
